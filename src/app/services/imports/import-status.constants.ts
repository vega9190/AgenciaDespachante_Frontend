export const IMPORT_STATUS_IDS = {
...
export const IMPORT_TIMELINE_STEPS: ImportTimelineStep[] = [
  {
    label: 'Nuevo',
    statusId: IMPORT_STATUS_IDS.nuevo
  },
  {
    label: 'En Proceso',
    statusId: IMPORT_STATUS_IDS.enProceso
  },
  {
    label: 'Declaración',
    statusId: IMPORT_STATUS_IDS.declaracion
  },
  {
    label: 'Autorizado',
    statusId: IMPORT_STATUS_IDS.autorizado
  },
  {
    label: 'Finalizado',
